  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="jumbotron jumbotron-fluid" id="elefantebot">
        <div class="container">
          <br>
          <h1 class="display-3">Cadastrar Atividade</h1>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md">
            <form class="" action="../../database/atividade/insert.php" method="post">
              <div class="form-group">
                <div class="row">
                  <div class="col">
                    <label for="nome">Nome</label>
                    <input type="text" class="form-control" name="nome" value="" placeholder="Digite o nome da Atividade">
                  </div>
                  	<div class="col">
                      <label for="valor">Valor</label>
                      <input type="text" class="form-control" name="valor" value="" placeholder="Digite o valor da Atividade">
                    </div>
                    <div class="col">
