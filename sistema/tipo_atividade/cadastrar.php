...
<html lang="pt-br">
  <head>
    ...
    <title><?= $titulo  ?> - Cadastrar Tipo de Atividade</title>
  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="jumbotron jumbotron-fluid" id="elefantebot">
        <div class="container">
          <br>
          <h1 class="display-3">Cadastrar Tipo de Atividade</h1>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md">
            <form class="" action="../../database/tipo_atividade/insert.php" method="post">
              <div class="form-group">
                	<label for="nome" class="texto">Nome</label>
                	<input type="text" class="form-control" name="nome" value="" placeholder="Digite o nome do Tipo de Atividade">
               </div>
               <div class="form-group">
