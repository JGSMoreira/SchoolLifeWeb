...
<html lang="pt-br">
  <head>
    ...
    <title><?= $titulo  ?> - Listar Tipos de Atividade</title>
  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link current" href="/sistema/painel.php">Painel</a>
          </li>
    ...
    <main role="main">
      ...
      <div class="jumbotron jumbotron-fluid" id="elefantebot">
        <div class="container">
          <br>
          <h1 class="display-3">Tipos de Atividade</h1>
        </div>
      </div>
          ...
          <div class="col-md">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <?php
                  if ($logado){
                    include '../../database/tipo_atividade/select.php';
                  }
                  else{
                    echo $mensagem;
                  }
            ...
            <div class="form-group">
              <a href="cadastrar.php"><button type="button" class="btn btn-primary">Cadastrar novo tipo de atividade</button></a>
