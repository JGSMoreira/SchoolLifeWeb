...
<html lang="pt-br">
  <head>
    ...
    <title><?= $titulo  ?> - Listar Matérias</title>
  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="jumbotron jumbotron-fluid" id="elefantebot">
        <div class="container">
          <br>
          <h1 class="display-3">Matérias</h1>
        </div>
      </div>
          ...
          <div class="col-md">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <?php
                  if ($logado){
                    include '../../database/materia/select.php';
                  }
                  else{
                    echo $mensagem;
                  }
            ...
            <div class="form-group">
              <a href="cadastrar.php"><button type="button" class="btn btn-primary">Cadastrar nova matéria</button></a>
